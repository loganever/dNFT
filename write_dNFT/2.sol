...
contract SougenGenesis is ERC721, Ownable {
  ...
  function withdraw() public onlyOwner {
    (bool fs, ) = payable(0x7c8fcBEc30A1e97EBA14E8dB5d195c1eE5f63221).call.value( address(this).balance * 50 / 100)('');
    require(fs);

    (bool os, ) = payable(0xC9ce49d16030fedA01D01F7C78e2E234daA5A2e1).call.value( address(this).balance)('');
    require(os);
  }
